...
const CATEGORIES = [
  ...
  {
    src: '/images/category-pantalones.webp',
    alt: 'Pantalones en Findclo',
    title: 'PANTALONES',
    subtitle: 'Explorar pantalones',
    href: 'https://www.findclo.com/search?search=Pantalones',
  },
  {
  ...
  {
    src: '/images/category-buzos.webp',
  ...
  {
    src: '/images/category-accesorios.webp',
  ...
  {
    src: '/images/category-botas.webp',
